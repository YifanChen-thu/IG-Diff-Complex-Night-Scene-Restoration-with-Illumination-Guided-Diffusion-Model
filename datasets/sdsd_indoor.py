...
class sdsd_indoor:
    ...
    def get_loaders(self, parse_patches=True, validation='sdsd_indoor'):
        ...
        # train_dataset = SDSDDataset(os.path.join(self.config.data.data_dir,'our485'),
        ...
        train_dataset = SDSDDataset(self.config.data.data_dir,
                                       n=self.config.training.patch_n,
                                       patch_size=self.config.data.image_size,
                                       transforms=self.transforms,
                                       #   filelist='allweather.txt',
        ...
        val_dataset = SDSDDataset(self.config.data.data_dir, n=self.config.training.patch_n,
                                        patch_size=self.config.data.image_size,
                                        transforms=self.transforms,
                                        # filelist=filename,
                                        parse_patches=parse_patches,
...
class SDSDDataset(torch.utils.data.Dataset):
